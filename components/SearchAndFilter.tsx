...
const SESSION_OPTIONS = [
  { value: "", label: "すべて", icon: "M4 6h16M4 12h16M4 18h16" },
  { value: "regular", label: "定例会", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
  { value: "extraordinary", label: "臨時会", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
  { value: "committee", label: "委員会", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" },
];
...
export function SearchAndFilter() {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100">
      ...
      {/* タグフィルター */}
      <div className="mt-4">
        <div className="text-xs font-medium text-gray-500 mb-2">トピックで絞り込み</div>
